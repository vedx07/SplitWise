...
function ChartPlaceholder({ text }) {
  return (
    <div className="h-[240px] flex items-center justify-center text-sm text-[#8b949e]">
      {text}
    </div>
  );
}
    ...
    const fetchCategoryData = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:3000/expense/dashboardCategoryBreakdown",
          {
            method: "GET",
            credentials: "include",
